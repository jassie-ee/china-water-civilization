...
const yangtzeRiverNodes: YangtzeRiverNode[] = [
  {
    id: 'dujiangyan', sequence: 1, name: '都江堰水利工程', shortName: '都江堰', type: 'engineering', regionId: 'upper',
    position: { x: 350, y: 300, labelOffsetX: -42, labelOffsetY: -30 }, isAvailable: true,
  ...
  {
    id: 'chishui-river', sequence: 2, name: '赤水河流域生态保护', shortName: '赤水河', type: 'ecological', regionId: 'upper',
    position: { x: 270, y: 620, labelOffsetX: -40, labelOffsetY: 58 }, isAvailable: true,
  ...
  {
    id: 'three-gorges', sequence: 3, name: '三峡工程', shortName: '三峡工程', type: 'engineering', regionId: 'middle',
    position: { x: 350, y: 420, labelOffsetX: -48, labelOffsetY: -30 }, isAvailable: true,
  ...
  {
    id: 'chinese-sturgeon-reserve', sequence: 4, name: '长江湖北宜昌中华鲟自然保护区', shortName: '中华鲟保护区', type: 'ecological', regionId: 'middle',
    position: { x: 510, y: 465, labelOffsetX: -58, labelOffsetY: 58 }, isAvailable: true,
  ...
  {
    id: 'dongting-lake', sequence: 6, name: '洞庭湖江湖调蓄与湿地', shortName: '洞庭湖', type: 'ecological', regionId: 'middle',
    position: { x: 730, y: 580, labelOffsetX: -36, labelOffsetY: 58 }, isAvailable: true,
  ...
  {
    id: 'danjiangkou', sequence: 5, name: '丹江口水利枢纽', shortName: '丹江口', type: 'engineering', regionId: 'middle',
    position: { x: 700, y: 280, labelOffsetX: -36, labelOffsetY: -30 }, isAvailable: true,
  ...
  {
    id: 'poyang-lake', sequence: 7, name: '鄱阳湖湿地与候鸟栖息地', shortName: '鄱阳湖', type: 'ecological', regionId: 'lower',
    position: { x: 960, y: 610, labelOffsetX: -36, labelOffsetY: 58 }, isAvailable: true,
  ...
  {
    id: 'taihu-governance', sequence: 8, name: '太湖流域综合治理', shortName: '太湖治理', type: 'engineering', regionId: 'lower',
    position: { x: 1210, y: 700, labelOffsetX: -36, labelOffsetY: 58 }, isAvailable: true,
  ...
  {
    id: 'jiangnan-water-town', sequence: 9, name: '江南水乡与湿地', shortName: '江南水乡', type: 'ecological', regionId: 'lower',
    position: { x: 1430, y: 735, labelOffsetX: -48, labelOffsetY: 58 }, isAvailable: true,
    summary: '资料待整理',
  },
];
