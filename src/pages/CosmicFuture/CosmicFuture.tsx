...
function CosmicFuture() {
  ...
  const spiritConfig: ChapterSpiritConfig = {
    pageId: 'chapter-four-guide', routePath: '/chapter-4', action: spiritAction,
    initialPosition: { x: 16, y: 82 }, spriteAlt: '小澜水精灵，可拖动并打开天地人和导览',
    dialogueId: 'cosmic-future-dialogue', dialoguePresentation: 'floating',
    dialogue: { conversationId: `cosmic-guide-${phase}-${assembledShardIds.length}-${reflectionChoiceId ?? 'none'}`, dialogLabel: '小澜：天地人和终章导览', messages: guideMessages, actionLabel: guideActionLabel, onAction: handleGuideAction },
  };
